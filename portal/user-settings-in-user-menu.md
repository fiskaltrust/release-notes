---
title: "Your Profile, Password and Language: All in the User Menu"
authors: platform
slug: portal/user-settings-in-user-menu
milestone: "n/a"
date: 2026-09-04
...
![The user menu under your name, with the profile links, the language picker and Sign out.](images/user-settings-in-user-menu/user-menu.png)
...
![Before: the "User info" group in the left sidebar.](images/user-settings-in-user-menu/before-sidebar.png)

![Before: the standalone language flag next to the basket in the top bar.](images/user-settings-in-user-menu/before-topbar.png)
