...
2. POS Dealers invite PosOperators to the fiskaltrust.Platform and either set their company data themselves (or hand over this responsibility to the Operator), and create a cashbox.
...
1. The required changes are made in the account of the PosOperator.
...
We are working on publishing an official procedural documentation for the steps described above as well, which can be handed out to PosOperators to explain how this flow works and what needs to be done in case of an audit.
