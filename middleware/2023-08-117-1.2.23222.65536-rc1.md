...
We've improved the French Middleware when dealing with copy receipt by creating a new table, called  ftJournalFRCopyPayload in the FR Queue where are stored copy receipts.
