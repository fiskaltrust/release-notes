...
## 🇩🇪 Fix: Improved SCU Switch Stability ([fiskaltrust/middleware#525](https://github.com/fiskaltrust/middleware/pull/525))
...
## 🇦🇹 Feature: Improved Startup Performance ([fiskaltrust/middleware#539](https://github.com/fiskaltrust/middleware/pull/539))
...
## 🇦🇹 Fix: Backup SCU Handling ([fiskaltrust/middleware#483](https://github.com/fiskaltrust/middleware/pull/483))

We've fixed a problem with the handling of backup SCUs. Now, when a normal SCU is not available, the backup SCU is used correctly.

::: caution

Currently, if a backup SCU was used for signing, this is not always reflected in the returned `ftState`.  
We're aware of this issue and will fix it in the next version.
